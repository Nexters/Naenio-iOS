    ...
    var data: Theme {
        ...
        case .todayVote:
            return Theme(
                content: "오늘 네니오들이\n가장 많이 참여한\n투표",
                title: "오늘의 투표",
                backgroundImage: "curation_theme01",
                backgroundColorList: [
        ...
        case .hallFame:
            return Theme(
                content: "네니오들이\n꾸준히 선택한 인기 있는\n투표",
                title: "명예의 전당",
                backgroundImage: "curation_theme02",
                backgroundColorList: [
        ...
        case .randomPlay:
            return Theme(
                content: "랜덤으로 참여하는\n플레이 투표",
                title: "랜덤 플레이",
                backgroundImage: "curation_theme03",
                backgroundColorList: [
        ...
        case .goldBalance:
            return Theme(
                content: "어떤 것 하나 쉽게\n선택할 수 없는\n투표",
                title: "황금 밸런스",
                backgroundImage: "curation_theme04",
                backgroundColorList: [
        ...
        case .noisy:
            return Theme(
                content: "네니오들이 가장\n많이 작성한 댓글\n참여 투표",
                title: "와글와글",
                backgroundImage: "curation_theme05",
                backgroundColorList: [
        ...
        case .collapsedBalance:
            return Theme(
                content: "네니오들이\n몰린 투표",
                title: "밸런스 붕괴",
                backgroundImage: "curation_theme06",
                backgroundColorList: [
